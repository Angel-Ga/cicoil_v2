...
if __name__ == "__main__":
  ...
  if PtoParam['sim']['StartTime'] == None:
      # starttime = (dt.datetime.today() - dt.timedelta(days=1))
  ...
  profile_name = ''.join((output_path, PtoParam['input']['curr'],'-v_profile_', txtTime, '_', PtoParam['point']['name'], '_',PtoParam['oil']['name'],'.nc'))
  ...
  output_name = ''.join((output_path,PtoParam['input']['curr'],'-tamoc_', txtTime, '_', PtoParam['point']['name'],'_',str(release_depth.as_integer_ratio()[0]),'m','_',PtoParam['oil']['name']))
